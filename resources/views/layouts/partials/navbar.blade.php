{{-- Navbar  --}}
<header class="inset-x-0 top-0 z-50 shadow-sm lg:static lg:overflow-y-visible backdrop-blur bg-zinc-900/20 ring-1 lg:flex text-zinc-400 ring-white/10">
            ...
            <div class="flex items-center justify-start">
                <div class="flex items-center flex-shrink-0">
                    <a href="{{ route('blog.index') }}">
                        <img class="block w-auto h-10" src="https://tailwindui.com/plus/img/logos/mark.svg?color=emerald&shade=600" alt="Logo" />
                    </a>
                </div>
            </div>
